 ...
 *        版本: 1.0
 */
public class NewJoinNeedActivity extends BaseFragmentActivity implements INewJoinSkillPageView {
	public static final String KEY = "workTypeEntity";
	private NeedDetailsAdapter adapter;
	...
	public static void jumpIn(Context context, Bundle bundle) {
		Intent intent = new Intent(context, NewJoinNeedActivity.class);
		if (bundle != null) {
	...
	protected void initActionbar() {
		...
		actionBar.setTitle(getString(R.string.new_join_need));
	...
	protected void initializeData(Bundle savedInstanceState) {
		...
		adapter = new NeedDetailsAdapter(this);
	...
	public void share(GoodsDetailEntity goodsDetailEntity) {
		ShareUtils.share(this,goodsDetailEntity, 2);
	}
