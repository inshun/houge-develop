...
/**     提现协议
 * Created by WT on 2016/6/17.
 */
public class WithdrawalWebview extends BaseFragmentActivity {

    private WebView webView;


    public static void jumpIn(Context context) {
        context.startActivity(new Intent(context, WithdrawalWebview.class));
    }

    @Override
    protected void setContentView() {
        setContentView(R.layout.withdrawal_webview);
    }

    @Override
    protected void initActionbar() {
        MyActionBar actionBar = new MyActionBar(this);
        actionBar.setTitle("提现协议");
    ...
    protected void initializeViews(Bundle savedInstanceState) {
        webView = (WebView) findViewById(R.id.wv_withDrawal);
    }
