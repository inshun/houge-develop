...
//			R.string.year);
//	private static String YESTER_DAY = MyApplication.getInstance().getString(
//			R.string.yesterday);
...
//			R.string.today);
//
//	private static String DATE_FORMAT = MyApplication.getInstance().getString(
//			R.string.date_format);
//	private static String YEAR_FORMAT = MyApplication.getInstance().getString(
