...
public class ImageGridAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if (type == TYPE_CAMERA) {
			view = mInflater.inflate(R.layout.item_list_camera, viewGroup, false);
			view.setTag(null);
		} else if (type == TYPE_NORMAL) {
			ViewHolde holde;
			if (view == null) {
				view = mInflater.inflate(R.layout.item_list_image, viewGroup, false);
	...
	class ViewHolde {
		...
		void bindData(final Image data) {
			...
			if (mItemSize > 0) {
				// 显示图片
				MyApplication.getInstance().getImageLoaderManager().loadNormalImage(image, "file://" + imageFile,
