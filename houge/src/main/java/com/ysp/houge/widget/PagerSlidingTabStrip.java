...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorHeight = 2;// 选中光标的高度
    private int underlineHeight = 0;// 光标下面一行的高度
    private int dividerPadding = 0; // 间隔线的填充
    ...
    private int tabBackgroundResId = R.drawable.tab_blue_bg;
