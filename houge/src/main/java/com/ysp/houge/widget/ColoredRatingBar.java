    ...
    private void init(Context context) {
        ...
        if(mType==SMALL){
			drawables = new Bitmap[] {
					BitmapFactory
							.decodeResource(res, R.drawable.color_rating_sel),
					BitmapFactory.decodeResource(res,
							R.drawable.color_rating_sel),
                    BitmapFactory
                            .decodeResource(res, R.drawable.color_rating_sel)
            };
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.color_rating_def);
        }else{
            drawables = new Bitmap[]{
                    BitmapFactory
                            .decodeResource(res, R.drawable.color_rating_sel),
