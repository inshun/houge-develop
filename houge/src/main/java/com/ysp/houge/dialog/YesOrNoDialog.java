...
public class YesOrNoDialog extends Dialog implements
	...
	private void initViews() {
		...
		mCancelBtn = (Button) this.findViewById(R.id.mCancelBtn);
		mSureBtn.setOnClickListener(this);
		mCancelBtn.setOnClickListener(this);
	}

	private void notifyDataSetChanged() {
		if (!TextUtils.isEmpty(dialogEntity.getBtnCancelLabel())) {
			mCancelBtn.setText(dialogEntity.getBtnCancelLabel());
