...
import com.easemob.easeui.widget.chatrow.EaseChatRowGood;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            if (TextUtils.equals(message.getStringAttribute("custometype", ""),"1")||TextUtils.equals(message.getStringAttribute("custometype", ""),"2")) {
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                ...
                }else  if (TextUtils.equals(message.getStringAttribute("custometype", ""),"1")||TextUtils.equals(message.getStringAttribute("custometype", ""),"2")) {
